...
const Welcome = ({ id, go, vkUser, userInfo, restRequest }) => { 
	...
	*/}		
			...
			<Div>
				<Button size="l" mode="primary" stretched={true} onClick={go} data-to="mainview.account-selection">
			...
			<Div>
				<Button size="l" mode="primary" stretched={true} onClick={go} data-to="registrationview.registrationlist">
			...
			<Div>
				<Button size="l" mode="primary" stretched={true} onClick={go} data-to="adminview.lobby">
					Администрирование
				</Button>
			</Div>
			}
			<Div>
				<Button size="l" mode="primary" stretched={true} onClick={go} data-to="welcomeview.help">
					Помощь
				</Button>
			</Div>
			{userInfo && parseInt(userInfo.is_blocked) !== 0 &&
